...
for mouseIdx = 1:n_mice
    ...
    beforeCueAnalysis = repmat(struct('rewardedNosepokes', [], 'unrewardedNosepokes', [], 'totalNosepokes', [], ...
        'probRewardedNosepoke', [],'unrewardedBetweenRewarded', [], 'latencyRewarded', [], 'latencyUnRewarded', [],...
        'rewardPortDurations', [],'portEntryBetweenRewardedNosepokes', [], 'latencyToPortReward', [],...
        'latencyToPortUnReward', [], 'totalInactiveNosepokes', []), n_trials, 1);
...
analysis.totalInactiveNosepokes = numel(period.InactiveTS);

analysis.totalNosepokes = analysis.rewardedNosepokes + analysis.unrewardedNosepokes;
...
analysis.latencyToPortReward = calcLatencyToPortEntry(rewardedNosepokes, period.PortEntryTS);
analysis.latencyToPortReward = analysis.latencyToPortReward/factor;

analysis.latencyToPortUnReward = calcLatencyToPortEntry(unrewardedNosepokes, period.PortEntryTS);
analysis.latencyToPortUnReward = analysis.latencyToPortUnReward/factor;
