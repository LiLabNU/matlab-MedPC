...
[MedPC_data, MedPC_trialTS, AnimalIDcell] = CocaineSA_MedPC2mat(MedPCfile, folderDir);
...
legendLabels = {'PumpOn', 'NoCocActiveNP', 'InactiveNP', 'CocTrigNP'};

Plot_individualRaster_CocSA(MedPC_data, AnimalIDcell, [imRows imColumns], bin, legendLabels);
